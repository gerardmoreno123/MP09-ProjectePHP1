...
<div class="flex-grow flex flex-col justify-center">
    <div class="border max-w-md mx-auto mt-6 blurred-section shadow-md rounded-lg p-6 mb-4">
        <h1 class="text-2xl font-bold mb-4 text-gray-900">Editar Peli</h1>
        <form action="/films/update" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" value="<?= htmlspecialchars($film->title) ?>" required class="mt-1 block w-full border border-gray-100 text-gray-700 placeholder-gray-700 rounded-full p-2 focus:outline-none" style="background-color: rgba(206, 206, 206, 0.6);" placeholder="Introdueix el títol de la pel·lícula">
            </div>

            <div class="mb-4">
                <label for="director" class="block text-gray-900">Director:</label>
                <input type="text" name="director" value="<?= htmlspecialchars($film->director) ?>" required class="mt-1 block w-full border border-gray-100 text-gray-700 placeholder-gray-700 rounded-full p-2 focus:outline-none" style="background-color: rgba(206, 206, 206, 0.6);" placeholder="Introdueix el nom del director">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="rating" step="0.1" value="<?= htmlspecialchars($film->rating) ?>" required class="mt-1 block w-full border border-gray-100 text-gray-700 placeholder-gray-700 rounded-full p-2 focus:outline-none" style="background-color: rgba(206, 206, 206, 0.6);" placeholder="Introdueix la valoració">
            </div>
