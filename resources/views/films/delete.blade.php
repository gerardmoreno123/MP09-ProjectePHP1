...
<div class="flex-grow flex flex-col justify-center">
    <div class="border max-w-md mx-auto blurred-section shadow-md rounded-lg p-6 text-center">
        <h1 class="text-3xl font-bold mb-4 text-gray-900">Eliminar Peli</h1>
        <p class="mb-4">Vols eliminar la pel·lícula "<span class="font-semibold"><?= htmlspecialchars($film->title) ?></span>"?</p>
        ...
        <a href="/films" class="text-black bg-gray-200 bg-opacity-50 border rounded hover:underline px-4 py-2 mt-4 block">Cancel·la</a>
    </div>
</div>
